...
public class ProgramState {
    ...
    MyLatchTable latchTable;

    public ProgramState(MyIStack<IStatement> executionStack, MyIDictionary<String, IValue> symbolsTable, MyIList<IValue> out, MyIDictionary<String, BufferedReader> fileTable, MyHeap heap, MyLatchTable latchTable, IStatement originalProgram){
    ...
    public MyLatchTable getLatchTable() {
        return latchTable;
    }

    public void setLatchTable(MyLatchTable latchTable) {
        this.latchTable = latchTable;
    }
    ...
    public MyLatchTable latchTableDeepCopy(){
        MyLatchTable latchTable = new MyLatchTable();

        this.latchTable.stream().forEach(
                e->latchTable.put(e.getKey(), e.getValue())
        );
