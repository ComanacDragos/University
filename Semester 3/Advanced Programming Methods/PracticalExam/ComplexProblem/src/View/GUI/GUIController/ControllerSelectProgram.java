...
import Model.Statements.LatchStatements.AwaitStatement;
    ...
    public void handleSelectProgram(MouseEvent mouseEvent) {
        if(mouseEvent.getClickCount() == 2){
            try{
                ...
                ProgramState newProgram = new ProgramState(executionStack, symbolsTable, out, fileTable, heap, new MyLatchTable(), statement);
