...
int main()
{
	...
	std::istream_iterator<double> endOfStreamIterator{}; // the default constructor constructs an end of stream iterator
	std::istream_iterator<double> in_it{ std::cin }; // reads successively from an input stream
